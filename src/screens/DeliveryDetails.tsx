...
import { View, Text, ScrollView, StyleSheet, TouchableOpacity, Alert, ActivityIndicator, ImageBackground } from "react-native";
      ...
      >
        <View style={styles.header}>
          ...
          <View style={styles.headerTextContainer}>
            ...
            <Text style={styles.headerSubtitle}>Detalles de productos</Text>
          </View>
    ...
    <Text style={styles.volunteerName}>{volunteer.name}</Text>
      ...
      <Text style={styles.detailValue}>No asignado</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("DeliveryQR", { delivery })}
          activeOpacity={0.8}
        >
          ...
          <View style={styles.qrButtonTextContainer}>
            <Text style={styles.qrButtonText}>Mostrar mi código QR</Text>
            <Text style={styles.qrButtonSubtext}>Para recibir mi despensa</Text>
          </View>
